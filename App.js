    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.combine}>
          <Button onPress={(() => {
            var RNMiService = NativeModules.RNMiService;
            RNMiService.combineMovie(this.state.count > this.state.rest ? (this.state.count - this.state.rest) : this.state.count);
        ...
        <View style={styles.startrails}>
          <Button onPress={(() => {
            var RNMiService = NativeModules.RNMiService;
            RNMiService.combineStartrails(this.state.count > this.state.rest ? (this.state.count - this.state.rest) : this.state.count);
          }).bind(this)} title="合成星轨"
            color="#841584"
